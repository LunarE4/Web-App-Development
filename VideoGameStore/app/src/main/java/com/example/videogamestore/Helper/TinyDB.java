...
public class TinyDB {
    ...
    public ArrayList<Games> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Games> playerList =  new ArrayList<Games>();

        for(String jObjString : objStrings){
            Games player  = gson.fromJson(jObjString,  Games.class);
    ...
    public void putListObject(String key, ArrayList<Games> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Games player: playerList){
